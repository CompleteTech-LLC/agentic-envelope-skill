# Start here: agentic-envelope-skill

<p align="center"><img src="assets/logo.png" alt="CompleteTech LLC logo" width="260"></p>

**CompleteTech LLC Skills** — Addressed envelopes and delivery packaging.
...
```bash
git clone https://github.com/CompleteTech-LLC/agentic-envelope-skill.git agentic-envelope-skill
cd agentic-envelope-skill
python3 -m venv .venv
. .venv/bin/activate
...
```bash
python generate_envelope.py --config config.ini examples/northwind_address.ini --out output/onboarding-demo.pdf
```

A demonstration addressed envelope appears at `output/onboarding-demo.pdf`. Check the recipient block, return address and print-at-100-percent instructions before any real mailing. Rendering does not buy postage or authorize delivery.
